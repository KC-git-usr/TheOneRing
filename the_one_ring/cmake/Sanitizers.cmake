...
function(validate_sanitizer_combinations)
  if(ENABLE_ASAN AND ENABLE_TSAN)
    message(FATAL_ERROR
      "ASan and TSan are mutually exclusive — they both intercept memory "
      "allocations and cannot coexist in the same binary.")
  endif()

  if(ENABLE_TSAN AND ENABLE_RTSAN)
    message(FATAL_ERROR
      "TSan and RTSan are mutually exclusive.")
  endif()

  if(ENABLE_COVERAGE AND (ENABLE_ASAN OR ENABLE_TSAN OR ENABLE_UBSAN OR ENABLE_RTSAN))
    message(WARNING
      "Mixing LLVM coverage instrumentation with sanitizers can produce "
...
function(apply_sanitizers target)
  ...
  if(ENABLE_UBSAN)
    list(APPEND _flags
      ...
      -fno-sanitize-recover=undefined)   # Abort on UB instead of continuing
  ...
  if(ENABLE_RTSAN)
    ...
    message(STATUS "[${target}] RealtimeSanitizer ON  (annotate RT functions with [[clang::nonblocking]])")
  endif()
